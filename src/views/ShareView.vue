  ...
  <section class="mx-9">
    ...
    <div class="flex flex-col my-10 gap-10">
      <div class="flex flex-col gap-3">
        <BaseParagraph
          :msg="`Bill ID #${mockData.id}`"
          class-name="text-gray-500 text-sm"
        />
        <div class="flex flex-col divide-y">
          <div
            class="flex flex-col gap-3 first:pt-0 first:pb-3 last:pt-8 last:pb-0"
            v-for="member in mockData.members"
          >
      ...
      <div class="flex flex-col gap-3">
        ...
        <div class="flex flex-col *:text-gray-500">
          <BaseParagraph
            :msg="`${mockData.billOwner.name} - ${mockData.billOwner.contact}`"
            className="text-xl"
          />
