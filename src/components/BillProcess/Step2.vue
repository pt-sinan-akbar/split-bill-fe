        ...
        <SliderModal :showModal="showModal">
            ...
            <template v-slot:body>
                <div class="w-full flex gap-y-5 flex-col justify-start">
                    <div
                        class="flex gap-x-5 border-b-2 pb-3"
                        v-for="item in assignTo"
                        :key="item.id"
                    >
                        <img
                            :src="item.image"
                    ...
                    <div>
                        ...
                        <BaseParagraph
                            msg="Long-press to edit person name or swipe left to delete"
                        />
                    </div>
                </div>
            </template>
            <template v-slot:fotoer>
                <div class="flex justify-between gap-x-5 sticky top-0">
                    <BaseButton
                        msg="Cancel"
                        type="button"
